...
namespace StudyHub.Infrastructure.Migrations
{
    ...
    [Migration("20260307153716_InitialStudyHubDb")]
    partial class InitialStudyHubDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LecturerLesson", b =>
                {
                    ...
                    b.ToTable("LecturerLessons", (string)null);
                });

            modelBuilder.Entity("LessonLessonsSlot", b =>
                {
                    b.Property<Guid>("LessonsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("LessonsSlotsId")
                        .HasColumnType("uuid");

                    b.HasKey("LessonsId", "LessonsSlotsId");

                    b.HasIndex("LessonsSlotsId");

                    b.ToTable("LessonToSlot", (string)null);
                });
            ...
            modelBuilder.Entity("StatisticTask", b =>
                {
                    ...
                    b.ToTable("TaskStatistics", (string)null);
                });
            ...
            modelBuilder.Entity("LessonLessonsSlot", b =>
                {
                    ...
                    b.HasOne("StudyHub.Domain.Entities.LessonsSlot", null)
                        .WithMany()
                        .HasForeignKey("LessonsSlotsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("StudyHub.Domain.Entities.User", b =>
                {
                    ...
                    b.HasOne("StudyHub.Domain.Entities.Schedule", "Schedule")
                        .WithMany("Users")
